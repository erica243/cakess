...
Class Action {
   ...
   function delete_cart() {
    ...
    <?php
// Make sure you're properly handling the request in forgot_password.php
    ...
    if ($result->num_rows === 0) {
        ...
        if ($stmt->affected_rows > 0) {
            ...
            try {
                ...
                $mail->Body = "<h2>Password Reset Request</h2><p>Your OTP for password reset is: <strong>$otp</strong></p><p>This OTP will expire in 15 minutes.</p><p>If you didn't request this, please ignore this email.</p>";
